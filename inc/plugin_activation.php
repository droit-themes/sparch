...
add_action( 'tgmpa_register', 'sparch_resister_required_plugin' );
/**
 ...
 */
function sparch_resister_required_plugin() {
    /*
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'             => 'https://sparch.droitlab.com/downloadfile/sparch-core.zip', // The plugin source.
