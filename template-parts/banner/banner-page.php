<?php 
  ...
  * Display page banner 
  */
$show_banner = sparch_options('sparch_page_banner_toggle', 'show');
$show_banner_in_page = sparch_page_meta('is_banner', get_the_ID(), 1);

$banner_url = sparch_options('sparch_page_banner_upload');
$banner_url_page= sparch_page_meta('banner_background_image', get_the_ID());  

$how_title = sparch_options('sparch_page_banner_title', 'show');
$show_breadcrumbs = sparch_options('sparch_page_banner_breadcrumb', 'show');
