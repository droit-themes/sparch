...
$show_banner = sparch_options('sparch_404_banner_toggle', 'show');
$banner_title = sparch_options('sparch_404_banner_title', '404');
  
$banner_url = sparch_options('sparch_404_banner_upload');

$how_title = sparch_options('sparch_404_banner_title', 'show');
$show_breadcrumbs = sparch_options('sparch_404_banner_breadcrumb', 'show');
