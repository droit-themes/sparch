...
if ( ! function_exists( '_themename_entry_meta_footer' ) ) :
	...
	function _themename_entry_meta_footer() {
		...
		$readmore_butotn_text = _themename_options('_themename_read_more_text_button', 'Read More');
	...
	*/
		...
		function _themename_logo () {
			...
			if(class_exists( 'Redux' ) ) {
				...
				$logo = _themename_options('_themename_logo'); 
				$logo_sticky = _themename_options('_themename_sticky_logo'); 
				$logo_ratina = _themename_options('_themename_retina_logo');
				$logo_ratina_sticky = _themename_options('_themename_retina_sticky_logo');
