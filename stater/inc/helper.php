 ...
 */
 ...
 if(!function_exists('_themename_options')){

    function _themename_options ( $section_id, $default = '' ) {
        ...
        if ( class_exists( 'Redux' ) ) {
            ...
            global $_themename;
            $option_data = (isset($_themename[$section_id]) && (!empty($_themename[$section_id]))) ? $_themename[$section_id] : $default;
