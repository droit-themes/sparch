...
/**
  * Display page banner 
  */
  $show_banner = _themename_options('_themename_blog_banner_toggle', 'show');
  
  $banner_url = _themename_options('_themename_blog_banner_upload');
  
  $how_title = _themename_options('_themename_blog_banner_title', 'show');
  $title = _themename_options('_themename_blog_title', get_bloginfo('name'));
  $show_breadcrumbs = _themename_options('_themename_blog_banner_breadcrumb', 'show');
